...
import br.com.incidisfy.persistence.dao.AnexosRepository;
...
public class TestAnexoService {
	
	@Mock
	private AnexosRepository mockRepository;
	...
	public void testFind() throws DaoException {
		...
		AnexoPayload find = service.find("1234");
