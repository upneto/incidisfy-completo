...
public class TestReclamacaoService {
	...
	public void testFind() throws DaoException {
		...
		ReclamacaoPayload find = service.find(123);

		Assert.assertNotNull(find);
		Assert.assertEquals(getMock().getCodigo(), find.getReclamacao().getCodigo());
	}
	...
	public void testFindAll() throws DaoException {
		...
		Assert.assertEquals(lista.get(0).getCodigo(), findAll.get(0).getReclamacao().getCodigo());
	}
